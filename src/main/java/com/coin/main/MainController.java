...
public class MainController {
	...
	@ResponseBody
	public String websiteVerification(@RequestParam(value = "urls", required = false) String urls) {
	...
	@ResponseBody
	public HashMap<String , String> bscVerification(@RequestParam(value = "contract", required = false) String contract) {
